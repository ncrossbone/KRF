Ext.define('KRF.view.common.DataWindow', {
	extend : 'Ext.window.Window',
	xtype : 'cmm-datawindow',
	...
	initComponent : function() {
		...
		//console.info(tab_panel);
		
		//alert(this.params.xtype);
...
function AddTab(parent, params){
	...
	console.info(parent.getActiveTab());
...
function CreateWindow(params){
	var north = Ext.getCmp('north-panel');
	var center = Ext.getCmp('center-panel');
	console.info(center.getWidth());
